 ...
 * @property {import('../../model/manager/manager-model').ManagerData} [manager] -
 * @property {import('../../model/league/league-model').LeagueData} [league] -
 * @property {import('../../model/team/team-model').TeamData} [team] -
 */
/**
